...
class ProductOverview extends StatefulWidget {
  ...
  const ProductOverview(
      {Key? key, required this.productId, required this.productImage, required this.productName, required this.productPrice, required this.productUnit}) : super(key: key);
